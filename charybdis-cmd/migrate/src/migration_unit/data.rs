...
impl<'a> MigrationUnitData<'a> {
    ...
    pub(crate) fn has_new_secondary_indexes(&self) -> bool {
        !self.new_secondary_indexes.is_empty()
    }

    pub(crate) fn has_removed_secondary_indexes(&self) -> bool {
        !self.removed_secondary_indexes.is_empty()
    }
